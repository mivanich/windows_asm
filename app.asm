...
; Compiler derectives and includes
...
include \masm32\include\kernel32.inc			; Handlers, modules, paths, etc
...
AppName		db	"Window from Assembler", 0		; The name of our main window
OutString	db	"Hello from Asm code!", 0
...
WinMain proc hInst:HINSTANCE, hPrevInst:HINSTANCE, CmdLine:LPSTR, CmdShow:DWORD
		...
		push	IDI_APPLICATION							; Use the default application
		push	NULL
		call	LoadIcon
		mov		wc.hIcon, eax
		mov		wc.hIconSm, eax
...
WndProc proc hWnd:HWND, uMsg:UINT, wParam:WPARAM, lParam:LPARAM
		...
		; xor eax, eax is faster than loading 0 to eax
		xor		eax, eax								; Return 0 to indicate we hadnled it. 
		ret
